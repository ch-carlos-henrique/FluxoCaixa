...
public sealed class OperationsWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    private readonly PostgreSqlContainer _postgres = new PostgreSqlBuilder()
        .WithDatabase("fluxocaixa_ops_test")
        .WithUsername("test")
        .WithPassword("test")
        .Build();
    ...
    {
        builder.UseSetting("ConnectionStrings:Operations", _postgres.GetConnectionString());
        ...
        builder.ConfigureServices(services =>
        {
            ...
            services.AddDbContext<TransactionDbContext>(opts =>
                opts.UseNpgsql(
                    ...
                    npg => npg.MigrationsHistoryTable("__ef_migrations_history_ops", "public")));
        });
    }
